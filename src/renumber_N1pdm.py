...
cmd.remove("chain H+E+J+L+F+K+G+I+M+N")
cmd.remove("resi 470+471+501+502")
...
for i, (r, aa) in enumerate(resis):
	...
	cmd.alter("chain A+B+C+D & resi %s & resn %s"%(r,aa), "resi='%s_'"%(new_resi))
